...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<Tenancy.IImportacionEntreEmpresasService, Tenancy.ImportacionEntreEmpresasService>();
        ...
        services.AddScoped<Tenancy.ITrdAdminService, Tenancy.TrdAdminService>();
        services.AddScoped<Tenancy.ITrdClienteService, Tenancy.TrdClienteService>();
        ...
        services.AddScoped<Tenancy.ICursoService, Tenancy.CursoService>();
        services.AddScoped<Tenancy.IClienteCursoService, Tenancy.ClienteCursoService>();
        ...
        services.AddScoped<Bpmn.IBpmnEngine, Bpmn.BpmnEngine>();
        services.AddScoped<Tenancy.ICuestionarioService, Tenancy.CuestionarioService>();
        services.AddScoped<Tenancy.IRetencionAlertaService, Tenancy.RetencionAlertaService>();
