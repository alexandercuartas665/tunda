...
public sealed class DatabaseSeeder
{
    ...
    // segun el sistema original de DokTrino IPS RT. Idempotente: solo agrega los que no
    ...
    public async Task EnsureCatalogosPacienteDefaultAsync(CancellationToken cancellationToken = default)
    {
        ...
        // Datos extraidos de las capturas del sistema legacy DokTrino.
        (DokTrino.Domain.Enums.CatalogoPacienteTipo tipo, string codigo, string nombre)[] items =
        {
            // ===== TIPO USUARIO =====
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.TipoUsuario, "COT", "Cotizante"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.TipoUsuario, "BEN", "Beneficiario"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.TipoUsuario, "SUB", "Subsidiado"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.TipoUsuario, "VIN", "Vinculado"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.TipoUsuario, "PAR", "Particular"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.TipoUsuario, "PRE", "Prepagada"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.TipoUsuario, "RES", "Regimen Especial"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.TipoUsuario, "MIG", "Poblacion Migrante"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.TipoUsuario, "NAF", "No afiliado"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.TipoUsuario, "EXC", "Excepcion"),

            // ===== CLASIFICACION PACIENTE =====
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.ClasificacionPaciente, "AGU", "AGUDO"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.ClasificacionPaciente, "CRO", "CRONICO"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.ClasificacionPaciente, "CRV", "CRONICO CON VENTILADOR"),

            // ===== CLASIFICACION GRUPO DE PATOLOGIA =====
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.ClasificacionGrupoPatologia, "RES", "RESPIRATORIO"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.ClasificacionGrupoPatologia, "CAR", "CARDIOVASCULAR"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.ClasificacionGrupoPatologia, "HEP", "HEPATICA"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.ClasificacionGrupoPatologia, "REN", "RENAL Y METABOLICA"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.ClasificacionGrupoPatologia, "NEU", "NEUROLOGICA"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.ClasificacionGrupoPatologia, "OST", "OSTEOARTICULAR"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.ClasificacionGrupoPatologia, "INF", "INFECCIOSAS"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.ClasificacionGrupoPatologia, "ONC", "ONCOLOGICA"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.ClasificacionGrupoPatologia, "MEN", "MENTAL"),

            // ===== TIPO TUTELA =====
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.TipoTutela, "INT", "INTEGRAL"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.TipoTutela, "PAR", "PARCIAL"),

            // ===== MED CONTRATADO =====
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.MedContratado, "SI", "SI"),
            (DokTrino.Domain.Enums.CatalogoPacienteTipo.MedContratado, "NO", "NO")
        };
    ...
    // las proporciono el cliente y son las del entorno PRODUCCION del sistema legacy DokTrino.
